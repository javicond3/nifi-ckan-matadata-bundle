 ...
 */
package org.apache.nifi.processors.ckan;
...
public class UpdateCkanMetadataAttributes extends AbstractProcessor {
    ...
    public static final PropertyDescriptor ORGANIZATION_TYPE = new PropertyDescriptor
            .Builder().name("organizationType")
    ...
    public static final PropertyDescriptor PACKAGE_DESCRIPTION = new PropertyDescriptor
            .Builder().name("packageDescription")
    ...
    public static final PropertyDescriptor PACKAGE_NAME = new PropertyDescriptor
    ...
    public static final PropertyDescriptor CONTACT_POINT = new PropertyDescriptor
            .Builder().name("contactPoint")
    ...
    public static final PropertyDescriptor CONTACT_NAME = new PropertyDescriptor
            .Builder().name("contactName")
    ...
    public static final PropertyDescriptor CONTACT_EMAIL = new PropertyDescriptor
            .Builder().name("contactEmail")
    ...
    public static final PropertyDescriptor KEYWORDS = new PropertyDescriptor
            .Builder().name("keywords")
    ...
    public static final PropertyDescriptor PUBLISHER_URL = new PropertyDescriptor
            .Builder().name("publisherURL")
    ...
    public static final PropertyDescriptor SPATIAL_COVERAGE = new PropertyDescriptor
            .Builder().name("spatialCoverage")
            .displayName("Spatial coverage")
            .description("T. It could be an URI, a Point or a set of Points (a POLIGON). "
            		+ "If it is an URI it is recommended to use the controlled vocabularies "
            		...
            		+ "Example1: https://publications.europa.eu/resource/authority/country/ESP"
            		+ "Example2: [175.0, 17.5]"
            		+ "Example3: [[[175.0, 17.5], [-65.5, 17.5], [-80.5, 10.5]]]" )
            .required(false)
            .expressionLanguageSupported(ExpressionLanguageScope.FLOWFILE_ATTRIBUTES)
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build(); 
    
    public static final PropertyDescriptor TEMPORAL_START = new PropertyDescriptor
            .Builder().name("temporalStart")
    ...
    public static final PropertyDescriptor TEMPORAL_END = new PropertyDescriptor
            .Builder().name("temporalEnd")
    ...
    public static final PropertyDescriptor THEMES = new PropertyDescriptor
            .Builder().name("themes")
            .displayName("Themes")
    ...
    public static final PropertyDescriptor VERSION = new PropertyDescriptor
    ...
    public static final PropertyDescriptor LANDING_PAGE = new PropertyDescriptor
            .Builder().name("landingPage")
    ...
    public static final PropertyDescriptor AVAILABILITY = new PropertyDescriptor
            .Builder().name("availability")
    ...
    public static final PropertyDescriptor RESOURCE_DESCRIPTION = new PropertyDescriptor
            .Builder().name("resourceDescription")
    ...
    public static final PropertyDescriptor LICENSE_TYPE = new PropertyDescriptor
            .Builder().name("licenseType")
    ...
    public static final PropertyDescriptor DOWNLOAD_URL = new PropertyDescriptor
            .Builder().name("downloadURL")
    ...
    public static final PropertyDescriptor BYTE_SIZE = new PropertyDescriptor
            .Builder().name("byteSize")
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        for (final PropertyDescriptor propertyDescriptor :  getSupportedPropertyDescriptors()) {
        	...
        	String propertyValue = context.getProperty(propertyDescriptor).evaluateAttributeExpressions(flowFile).getValue();
